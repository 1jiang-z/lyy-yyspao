...
if (exportAllBtn) {
        exportAllBtn.addEventListener('click', async function() {
            ...
            overlay.innerHTML = `
                <div style="background:var(--secondary-bg);border-radius:20px;padding:24px;width:88%;max-width:380px;box-shadow:0 20px 60px rgba(0,0,0,0.4);animation:modalContentSlideIn 0.3s ease forwards;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:9px;margin-bottom:20px;">
                        ...
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--primary-bg);font-size:13px;color:var(--text-primary);">
                            <input type="checkbox" id="_bk_mood" checked style="accent-color:var(--accent-color);width:15px;height:15px;">
                            <i class="fas fa-heart" style="color:var(--accent-color);width:16px;text-align:center;"></i>
                            <span>心情日历</span>
                        </label>
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--primary-bg);font-size:13px;color:var(--text-primary);">
                            <input type="checkbox" id="_bk_bookshelf" checked style="accent-color:var(--accent-color);width:15px;height:15px;">
                            <i class="fas fa-book-open" style="color:var(--accent-color);width:16px;text-align:center;"></i>
                            <span>书架与问卷</span>
                        </label>
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--primary-bg);font-size:13px;color:var(--text-primary);">
                            <input type="checkbox" id="_bk_touch" checked style="accent-color:var(--accent-color);width:15px;height:15px;">
                            <i class="fas fa-hand-pointer" style="color:var(--accent-color);width:16px;text-align:center;"></i>
                            <span>戳戳梦角</span>
                        </label>
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--primary-bg);font-size:13px;color:var(--text-primary);">
                            <input type="checkbox" id="_bk_invitation" checked style="accent-color:var(--accent-color);width:15px;height:15px;">
                            <i class="fas fa-heart-broken" style="color:var(--accent-color);width:16px;text-align:center;"></i>
                            <span>邀请功能</span>
                        </label>
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--primary-bg);font-size:13px;color:var(--text-primary);">
                            <input type="checkbox" id="_bk_messagewall" checked style="accent-color:var(--accent-color);width:15px;height:15px;">
                        ...
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--primary-bg);font-size:13px;color:var(--text-primary);">
                            <input type="checkbox" id="_bk_tarot" checked style="accent-color:var(--accent-color);width:15px;height:15px;">
                            <i class="fas fa-star" style="color:var(--accent-color);width:16px;text-align:center;"></i>
                            <span>塔罗占卜</span>
                        </label>
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--primary-bg);font-size:13px;color:var(--text-primary);">
                            <input type="checkbox" id="_bk_battle" checked style="accent-color:var(--accent-color);width:15px;height:15px;">
                            <i class="fas fa-sword" style="color:var(--accent-color);width:16px;text-align:center;"></i>
                            <span>作战陪伴</span>
                        </label>
                    </div>
            ...
            if (bkConfirmBtn) bkConfirmBtn.onclick = async function() {
                ...
                const inclMood    = document.getElementById('_bk_mood').checked;
                const inclBookshelf = document.getElementById('_bk_bookshelf').checked;
                const inclTouch   = document.getElementById('_bk_touch').checked;
                const inclInvitation = document.getElementById('_bk_invitation').checked;
                const inclMessageWall = document.getElementById('_bk_messagewall').checked;
                const inclMusic   = document.getElementById('_bk_music').checked;
                const inclTarot   = document.getElementById('_bk_tarot').checked;
                const inclBattle  = document.getElementById('_bk_battle').checked;
                ...
                if (!inclMsgs && !inclSet && !inclCustom && !inclAnn && !inclThemes && !inclDg && !inclStickers &&
                    ...
                    !inclDiary && !inclAccounting && !inclEnvelope && !inclMood && !inclBookshelf && !inclTouch &&
                    !inclInvitation && !inclMessageWall && !inclMusic && !inclTarot && !inclBattle) {
                ...
                try {
                    if (typeof ChatBackup !== 'undefined' && ChatBackup.buildBackupPayload && ChatBackup.serializeBackupV4) {
                        const payload = await ChatBackup.buildBackupPayload({
                            ...
                            inclMood: inclMood,
                            inclBookshelf: inclBookshelf,
                            inclTouch: inclTouch,
                            inclInvitation: inclInvitation,
                            inclMessageWall: inclMessageWall,
                            inclMusic: inclMusic,
                            inclTarot: inclTarot,
                            inclBattleCompanion: inclBattle
                        });
