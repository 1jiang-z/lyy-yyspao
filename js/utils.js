    ...
    try {
        if (typeof ChatBackup !== 'undefined' && ChatBackup.buildBackupPayload && ChatBackup.serializeBackupV4) {
            const payload = await ChatBackup.buildBackupPayload({
                ...
                inclTouch: true,
                inclInvitation: true,
                inclMessageWall: true,
                inclMusic: true,
                inclBattleCompanion: true
            });
    ...
    try {
        ...
        const categories = [
            ...
            },
            {
                id: 'bookshelf',
                label: '书架与问卷',
                indexedDBNeedles: ['dreamQuestionnaires', 'userBookshelf', 'readerWindowState', 'bookshelf'],
                localStorageNeedles: []
            },
            {
                id: 'touch',
                label: '戳戳梦角',
                indexedDBNeedles: ['touchData'],
                localStorageNeedles: ['touch_data']
            },
            {
                id: 'invitation',
                label: '邀请功能',
                indexedDBNeedles: ['invitation_'],
                localStorageNeedles: []
            },
            {
                id: 'map',
                label: '地图标记',
                indexedDBNeedles: ['mapData', 'MAP_'],
                localStorageNeedles: []
            },
            {
                id: 'messagewall',
                label: '留言墙',
                indexedDBNeedles: ['messageWallData', 'messageWall'],
                localStorageNeedles: []
            },
            {
                id: 'music',
                label: '音乐歌单',
                indexedDBNeedles: ['playerCover', 'customSongs'],
                localStorageNeedles: []
            },
            {
                id: 'pet',
                ...
                localStorageNeedles: ['luelue_pet_game']
            },
            {
                id: 'tarot',
                label: '塔罗占卜',
                indexedDBNeedles: ['diviHistory', 'customTarotDeck', 'customTarotEnabled'],
                localStorageNeedles: ['tarot_data']
            },
            {
                id: 'battleCompanion',
                label: '作战陪伴',
                indexedDBNeedles: ['battleCompanionData'],
                localStorageNeedles: []
            }
        ];
