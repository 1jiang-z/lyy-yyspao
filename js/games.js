...
(function() {
    ...
    function drawWordCloud(canvas, words) {
        ...
        words.forEach(function(item, idx) {
            ...
            // 优化：增大步长减少迭代次数，从 3555 次 → 约 200 次
            for (var t = 0; t < 120; t += 0.6) {
                var ang = t * 2.0;
                var r   = 2.0 * ang;
    ...
    window.renderWordCloud = function() {
        ...
        var pTop = topWords(pFreq, 45);
        var mTop = topWords(mFreq, 45);
        var aTop = topWords(aFreq, 45);
